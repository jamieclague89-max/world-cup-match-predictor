...
export default function WhatsAppBanner() {
  const [dismissed, setDismissed] = useState(
    () => sessionStorage.getItem('wa_banner_dismissed') === '1'
  );
  ...
  return (
    <div className="flex items-center gap-3 mt-4 mb-1 px-4 py-3 rounded-xl border
                    bg-[#0d2318] border-[#25d366]/25">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-slate-400 text-xs leading-snug hidden sm:block">
          Chat with other predictors, discuss matches and trash talk
        </p>
      </div>
      ...
      <a
        ...
        className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg
                   bg-[#25d366] hover:bg-[#1db954] text-white text-xs font-bold
