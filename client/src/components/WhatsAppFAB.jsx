...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-40
    ...
    >
      ...
      <span className="pointer-events-none absolute right-16 top-1/2 -translate-y-1/2
                       ...
                       bg-pitch-900 text-white text-xs font-semibold
        ...
        <span className="absolute right-[-5px] top-1/2 -translate-y-1/2
                         w-0 h-0 border-t-4 border-b-4 border-l-[5px]
                         border-t-transparent border-b-transparent border-l-pitch-700" />
      </span>
    </a>
  );
}
